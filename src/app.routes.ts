...
export const appRoutes: Routes = [
    ...
    },
    {
        ...
        children: [
            ...
            { path: 'manual-comparison-view', loadComponent: () => import('./app/pages/situation-center/reservoirs-info/manual-comparison-view/manual-comparison-view.component').then(m => m.ManualComparisonViewComponent), canActivate: [filtrationGuard] },
