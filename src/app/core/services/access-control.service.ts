...
const MOCK_ZONES: AccessZone[] = [
    ...
    { id: 3, name: 'Машинный зал', code: 'MACH-HALL', location: 'Молокозавод «Чирчик»', security_level: 'restricted', requires_escort: false, max_occupancy: 50, current_occupancy: 12, readers: [{ id: 3, name: 'Турникет МЗ', zone_id: 3, type: 'card', direction: 'both', is_online: true }], is_active: true },
    { id: 4, name: 'Диспетчерская', code: 'DISPATCH', location: 'Молокозавод «Чирчик»', security_level: 'critical', requires_escort: true, max_occupancy: 8, current_occupancy: 3, readers: [{ id: 4, name: 'Комбо-вход', zone_id: 4, type: 'combined', direction: 'entry', is_online: true }], is_active: true }
];

const MOCK_CARDS: AccessCard[] = [
    { id: 1, card_number: 'AC-001-2024', employee_id: 1, employee_name: 'Каримов Бахтиёр Рустамович', employee_code: 'EMP-001', department_name: 'Молокозавод «Чирчик»', position_name: 'Главный инженер', status: 'active', issued_at: '2024-03-15', valid_from: '2024-03-15', valid_until: '2027-03-15', access_zones: [1, 2, 3, 4], last_used_at: '2026-03-04T08:12:00Z', last_zone: 'Главный вход' },
    ...
    { id: 3, card_number: 'AC-003-2025', employee_id: 3, employee_name: 'Рахимов Отабек Шухратович', employee_code: 'EMP-003', department_name: 'Молокозавод «Фергана»', position_name: 'Инженер-технолог', status: 'active', issued_at: '2025-01-10', valid_from: '2025-01-10', valid_until: '2028-01-10', access_zones: [1, 3], last_used_at: '2026-03-04T07:55:00Z', last_zone: 'Машинный зал' },
    { id: 4, card_number: 'AC-004-2025', employee_id: 4, employee_name: 'Абдуллаев Жасур Тохирович', employee_code: 'EMP-004', department_name: 'Молокозавод «Джизак»', position_name: 'Оператор', status: 'blocked', issued_at: '2025-06-01', valid_from: '2025-06-01', valid_until: '2028-06-01', access_zones: [1], notes: 'Заблокирована по причине утери' },
