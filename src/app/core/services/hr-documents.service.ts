...
const MOCK_DOCUMENTS: HRDocument[] = [
    {
        ...
        status: 'signed', employee_id: 1, employee_name: 'Каримов Бахтиёр Рустамович', department_id: 1, department_name: 'Молокозавод «Чирчик»',
    ...
    },
    {
        ...
        status: 'pending_signature', employee_id: 3, employee_name: 'Рахимов Отабек Шухратович', department_id: 4, department_name: 'Молокозавод «Фергана»',
    ...
    },
    {
        ...
        status: 'signed', employee_id: 4, employee_name: 'Абдуллаев Жасур Тохирович', department_id: 2, department_name: 'Молокозавод «Джизак»',
...
const MOCK_REQUESTS: DocumentRequest[] = [
    {
        id: 1, document_type: 'certificate', employee_id: 4, employee_name: 'Абдуллаев Жасур Тохирович', department_name: 'Молокозавод «Джизак»',
    ...
    {
        id: 2, document_type: 'certificate', employee_id: 1, employee_name: 'Каримов Бахтиёр Рустамович', department_name: 'Молокозавод «Чирчик»',
