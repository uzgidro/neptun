...
const MOCK_DASHBOARD: HRMDashboard = {
    ...
    events: [
        {
            ...
            description: 'Ежегодное обучение по технике безопасности на ГЭС',
            date: '2026-03-10',
            time: '09:00',
            location: 'Конференц-зал, Чарвакская ГЭС',
        ...
        },
        {
            ...
            description: 'Собеседование на позицию главного инженера Туямуюнской ГЭС',
            date: '2026-03-08',
            time: '11:00',
            location: 'Главный офис, г. Ташкент',
            icon: 'pi-user',
    ...
    notifications: [
        ...
        },
        {
            ...
            message: 'Оформлен прием на работу: Рахматуллаев Сардор — Инженер-гидролог, Ходжикентская ГЭС',
    ...
    recentActivity: [
        {
            ...
            description: 'Рахматуллаев Сардор принят на должность инженера-гидролога',
        ...
        },
        {
            ...
            description: 'Курс "Безопасность на гидротехнических сооружениях" — 12 сотрудников',
            user_name: 'Система',
        ...
        },
        {
            ...
            description: 'Опубликована вакансия: Главный инженер, Туямуюнская ГЭС',
            user_name: 'Нурматов Фаррух',
    ...
    upcomingBirthdays: [
        {
            ...
            position_name: 'Старший инженер-энергетик',
        ...
        },
        {
            ...
            department_name: 'Служба эксплуатации Чарвакской ГЭС',
    ...
    expiringProbations: [
        ...
        },
        {
            ...
            position_name: 'Инженер-гидролог',
