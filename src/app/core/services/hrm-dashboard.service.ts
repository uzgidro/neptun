...
const MOCK_DASHBOARD: HRMDashboard = {
    ...
    events: [
        {
            ...
            date: '2026-03-10',
            time: '09:00',
            location: 'Конференц-зал, Молокозавод «Чарвак»',
        ...
        },
        {
            ...
            description: 'Собеседование на позицию главного инженера Молокозавода «Туямуюн»',
            date: '2026-03-08',
            time: '11:00',
            location: 'Главный офис, г. Ташкент',
            icon: 'pi-user',
    ...
    notifications: [
        ...
        },
        {
            ...
            message: 'Оформлен прием на работу: Рахматуллаев Сардор — Инженер-технолог, Молокозавод «Ходжикент»',
    ...
    recentActivity: [
        ...
        },
        {
            ...
            description: 'Опубликована вакансия: Главный инженер, Молокозавод «Туямуюн»',
            user_name: 'Нурматов Фаррух',
