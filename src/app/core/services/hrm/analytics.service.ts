...
const MOCK_DASHBOARD: HRAnalyticsDashboard = {
    ...
    department_headcount: [
        { department_id: 1, department_name: 'Молокозавод «Чирчик»', headcount: 485 },
        { department_id: 2, department_name: 'Молокозавод «Джизак»', headcount: 312 },
        { department_id: 3, department_name: 'Молокозавод «Газалкент»', headcount: 198 },
        { department_id: 4, department_name: 'Молокозавод «Фергана»', headcount: 425 },
...
export class HRAnalyticsService {
    ...
    getTurnoverReport(filter?: AnalyticsFilter): Observable<TurnoverReport> {
        if (USE_MOCK) return of({
            ...
            by_department: [
                { department: 'Молокозавод «Чирчик»', terminations: 22, turnover_rate: 4.5 },
                { department: 'Молокозавод «Фергана»', terminations: 18, turnover_rate: 4.2 },
    ...
    getAttendanceReport(filter?: AnalyticsFilter): Observable<AttendanceReport> {
        if (USE_MOCK) return of({
            ...
            by_department: [
                { department: 'Молокозавод «Чирчик»', attendance_rate: 95.2, absence_rate: 4.8 },
    ...
    getSalaryReport(filter?: AnalyticsFilter): Observable<SalaryReport> {
        if (USE_MOCK) return of({
            ...
            by_department: [
                { department: 'Молокозавод «Чирчик»', avg_salary: 5200000, total_payroll: 2522000000, headcount: 485 },
                { department: 'Молокозавод «Фергана»', avg_salary: 4800000, total_payroll: 2040000000, headcount: 425 },
    ...
    getPerformanceReport(filter?: AnalyticsFilter): Observable<PerformanceReport> {
        if (USE_MOCK) return of({
            ...
            by_department: [
                { department: 'Молокозавод «Чирчик»', avg_rating: 4.0, goal_rate: 65 },
                { department: 'Молокозавод «Фергана»', avg_rating: 3.7, goal_rate: 58 },
