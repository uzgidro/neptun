...
export class PerformanceService {
    ...
    private get API_URL(): string {
        return this.configService.apiBaseUrl + '/hrm/performance';
    }
    ...
    getReviews(params?: { status?: string; type?: string; employee_id?: number; search?: string }): Observable<PerformanceReview[]> {
        ...
        return this.http.get<PerformanceReview[]>(`${this.API_URL}/reviews`, { params: httpParams });
    }

    getReviewById(id: number): Observable<PerformanceReview> {
        return this.http.get<PerformanceReview>(`${this.API_URL}/reviews/${id}`);
    }

    createReview(payload: PerformanceReviewPayload): Observable<PerformanceReview> {
        return this.http.post<PerformanceReview>(`${this.API_URL}/reviews`, payload);
    }

    updateReview(id: number, payload: Partial<PerformanceReviewPayload>): Observable<PerformanceReview> {
        return this.http.patch<PerformanceReview>(`${this.API_URL}/reviews/${id}`, payload);
    }

    submitSelfReview(id: number, payload: SelfReviewPayload): Observable<PerformanceReview> {
        return this.http.post<PerformanceReview>(`${this.API_URL}/reviews/${id}/self-review`, payload);
    }

    submitManagerReview(id: number, payload: ManagerReviewPayload): Observable<PerformanceReview> {
        return this.http.post<PerformanceReview>(`${this.API_URL}/reviews/${id}/manager-review`, payload);
    }

    completeReview(id: number): Observable<PerformanceReview> {
        return this.http.post<PerformanceReview>(`${this.API_URL}/reviews/${id}/complete`, {});
    }
    ...
    getGoals(params?: { status?: string; employee_id?: number; review_id?: number }): Observable<PerformanceGoal[]> {
        ...
        return this.http.get<PerformanceGoal[]>(`${this.API_URL}/goals`, { params: httpParams });
    }

    createGoal(payload: GoalPayload): Observable<PerformanceGoal> {
        return this.http.post<PerformanceGoal>(`${this.API_URL}/goals`, payload);
    }

    updateGoal(id: number, payload: Partial<GoalPayload>): Observable<PerformanceGoal> {
        return this.http.patch<PerformanceGoal>(`${this.API_URL}/goals/${id}`, payload);
    }

    updateGoalProgress(id: number, currentValue: number): Observable<PerformanceGoal> {
        return this.http.patch<PerformanceGoal>(`${this.API_URL}/goals/${id}/progress`, { current_value: currentValue });
    }

    deleteGoal(id: number): Observable<void> {
        return this.http.delete<void>(`${this.API_URL}/goals/${id}`);
    }
    ...
    getRatings(): Observable<PerformanceRating[]> {
        return this.http.get<PerformanceRating[]>(`${this.API_URL}/ratings`);
    }

    getEmployeeRating(employeeId: number): Observable<PerformanceRating> {
        return this.http.get<PerformanceRating>(`${this.API_URL}/ratings/employee/${employeeId}`);
    }

    getDashboard(): Observable<PerformanceDashboard> {
        return this.http.get<PerformanceDashboard>(`${this.API_URL}/dashboard`);
    }
}
