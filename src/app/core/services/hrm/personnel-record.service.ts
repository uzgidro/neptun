...
const MOCK_TRANSFERS: PersonnelTransfer[] = [
    {
        ...
        from_department_name: 'Молокозавод «Андижан»',
        to_department_id: 10,
        to_department_name: 'Служба эксплуатации Молокозавода «Чирчик»',
    ...
    },
    {
        ...
        from_department_name: 'Молокозавод «Джизак»',
        to_department_id: 10,
    ...
    createTransfer(recordId: number, transfer: Partial<PersonnelTransfer>): Observable<PersonnelTransfer> {
        if (USE_MOCK)
            return of({
                ...
                to_department_name: transfer.to_department_name || 'Молокозавод «Андижан»',
