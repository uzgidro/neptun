...
const MOCK_TRANSFERS: PersonnelTransfer[] = [
    {
        ...
        from_department_name: 'Туямуюнская ГЭС',
        to_department_id: 10,
        to_department_name: 'Служба эксплуатации Чарвакской ГЭС',
        from_position_id: 205,
        from_position_name: 'Инженер-энергетик',
        to_position_id: 201,
    ...
    },
    {
        ...
        from_department_name: 'Ходжикентская ГЭС',
        to_department_id: 10,
        to_department_name: 'Техническое управление',
        from_position_id: 205,
        from_position_name: 'Инженер-энергетик',
        to_position_id: 202,
        to_position_name: 'Старший инженер-энергетик',
    ...
    createTransfer(recordId: number, transfer: Partial<PersonnelTransfer>): Observable<PersonnelTransfer> {
        if (USE_MOCK)
            return of({
                ...
                to_department_name: transfer.to_department_name || 'Туямуюнская ГЭС',
                from_position_id: transfer.from_position_id || 202,
                from_position_name: transfer.from_position_name || 'Старший инженер-энергетик',
