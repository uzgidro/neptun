...
const MOCK_VACANCIES: Vacancy[] = [
    {
        ...
        description: 'Обеспечение технической эксплуатации производственных объектов Молокозавода «Чирчик». Контроль состояния пастеризаторов, сепараторов и ёмкостей.',
    ...
    },
    {
        ...
        description: 'Управление работой производственного оборудования на Молокозаводе «Джизак». Контроль параметров сепараторов, пастеризаторов и систем регулирования.',
...
const MOCK_INTERVIEWS: Interview[] = [
    ...
    },
    {
        ...
        location: 'Производственный цех Молокозавода «Джизак» (практическое)', status: 'completed',
        competency_scores: [
