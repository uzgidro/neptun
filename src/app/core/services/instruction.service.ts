...
export class InstructionService {
    private mockInstructions: Instruction[] = [
        ...
        },
        {
            ...
            number: 'ИН-002',
            date: '2024-02-01',
            title: 'Инструкция по эксплуатации гидротурбин',
            description: 'Порядок запуска, остановки и обслуживания гидротурбин',
            category: 'operation',
            status: 'active',
        ...
        },
        {
            ...
            number: 'ИН-003',
            date: '2024-03-10',
            title: 'Инструкция по техническому обслуживанию генераторов',
            description: 'Регламент планового технического обслуживания генераторов ГЭС',
            category: 'technical',
            status: 'active',
            approvedBy: 'Главный инженер Петров П.П.',
