...
const MOCK_GOALS: PerformanceGoal[] = [
    ...
    },
    {
        id: 2,
        employee_id: 102,
        title: 'Снизить время незапланированных простоев турбинного оборудования на 15%',
        target_value: 15,
        current_value: 9,
        weight: 25,
        status: 'in_progress',
...
const MOCK_REVIEWS: PerformanceReview[] = [
    {
        ...
        self_rating: 4,
        self_comment: 'В течение отчётного периода обеспечил стабильную работу генераторного оборудования, выполнил план по выработке на 98%.',
        manager_rating: 4,
        manager_comment: 'Сотрудник демонстрирует высокий уровень компетенций в управлении энергетическим оборудованием. Рекомендуется к повышению квалификации по SCADA-системам.',
        final_rating: 4,
    ...
    },
    {
        ...
        goals: [MOCK_GOALS[1]],
        self_rating: 3,
        self_comment: 'Выполнял плановые работы по техническому обслуживанию турбинного оборудования. Столкнулся с задержками поставки запасных частей.',
        manager_rating: null,
