    ...
    private mockData: PersonnelLoss[] = [
        {
            ...
            organization: { id: 1, name: 'Нурекская ГЭС', contacts: [] },
            lossType: 'retirement',
            lossDate: '2024-06-15',
            hireDate: '1989-03-10',
        ...
        },
        {
            ...
            photo: null,
            position: { id: 2, name: 'Оператор ГЭС' },
        ...
        },
        {
            ...
            organization: { id: 2, name: 'Сангтудинская ГЭС-1', contacts: [] },
            lossType: 'dismissal',
            lossDate: '2024-09-01',
            hireDate: '2018-02-15',
        ...
        },
        {
            ...
            yearsOfService: 9,
            achievements: null,
            notes: 'Переведен в Рогунскую ГЭС'
        },
        {
            id: 5,
            ...
            organization: { id: 3, name: 'Байпазинская ГЭС', contacts: [] },
            lossType: 'death',
            lossDate: '2023-11-05',
            hireDate: '1995-06-12',
