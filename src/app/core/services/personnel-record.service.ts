...
const MOCK_PERSONNEL_RECORDS: PersonnelRecord[] = [
    {
        ...
        department_id: 1, department_name: 'Чарвакская ГЭС', position_id: 1, position_name: 'Начальник смены',
        ...
        transfers: [
            { id: 1, personnel_record_id: 1, from_department_id: 5, from_department_name: 'Ахангаранская ГЭС', to_department_id: 1, to_department_name: 'Чарвакская ГЭС', from_position_id: 6, from_position_name: 'Инженер-энергетик', to_position_id: 1, to_position_name: 'Начальник смены', transfer_date: '2020-06-01', order_number: 'ПР-2020/187', reason: 'Повышение в должности' }
        ],
    ...
    },
    {
        ...
        department_id: 3, department_name: 'Фархадская ГЭС', position_id: 2, position_name: 'Оператор турбинного оборудования',
        ...
        transfers: [
            { id: 2, personnel_record_id: 3, from_department_id: 3, from_department_name: 'Фархадская ГЭС', to_department_id: 3, to_department_name: 'Фархадская ГЭС', from_position_id: 3, from_position_name: 'Электромонтёр', to_position_id: 2, to_position_name: 'Оператор турбинного оборудования', transfer_date: '2017-01-10', order_number: 'ПР-2017/012', reason: 'Повышение квалификации' }
        ],
    ...
    },
    {
        ...
        department_id: 7, department_name: 'Чирчик-Бозсуйский каскад ГЭС', position_id: 3, position_name: 'Электромонтёр',
    ...
    },
    {
        ...
        department_id: 2, department_name: 'Ходжикентская ГЭС', position_id: 4, position_name: 'Диспетчер',
        contract_type: 'permanent', status: 'active',
        documents: [
        ...
        transfers: [
            { id: 3, personnel_record_id: 5, from_department_id: 1, from_department_name: 'Чарвакская ГЭС', to_department_id: 2, to_department_name: 'Ходжикентская ГЭС', from_position_id: 4, from_position_name: 'Диспетчер', to_position_id: 4, to_position_name: 'Диспетчер', transfer_date: '2021-03-15', order_number: 'ПР-2021/078', reason: 'Перевод по производственной необходимости' }
        ],
