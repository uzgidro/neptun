...
const MOCK_VACANCIES: Vacancy[] = [
    {
        ...
        description: 'Руководство эксплуатацией и техническим обслуживанием производственного оборудования Молокозавода «Чарвак» мощностью 620 тонн/ч.',
...
const MOCK_INTERVIEWS: Interview[] = [
    {
        ...
        duration_minutes: 60,
        location: 'Молокозавод «Чарвак», кабинет 204',
        status: 'scheduled',
    ...
    },
    {
        ...
        duration_minutes: 90,
        location: 'Молокозавод «Ходжикент», кабинет директора',
        status: 'completed',
        overall_rating: 4.8,
...
const MOCK_OFFERS: JobOffer[] = [
    ...
    },
    {
        ...
        offered_department: 'Молокозавод «Туямуюн»',
