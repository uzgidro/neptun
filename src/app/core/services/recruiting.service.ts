...
const MOCK_VACANCIES: Vacancy[] = [
    {
        id: 1,
        title: 'Главный инженер гидроагрегатов',
        department_id: 10,
        department_name: 'Чарвакская ГЭС',
        position_id: 101,
        position_name: 'Главный инженер',
        description: 'Руководство эксплуатацией и техническим обслуживанием гидроагрегатов Чарвакской ГЭС мощностью 620 МВт.',
        requirements: 'Высшее техническое образование (гидроэнергетика), стаж работы от 10 лет, опыт управления гидроагрегатами мощностью от 100 МВт.',
    ...
    },
    {
        ...
        department_id: 11,
        department_name: 'Ходжикентская ГЭС',
        position_id: 102,
        position_name: 'Инженер-электрик',
        description: 'Обслуживание электрических систем и трансформаторного оборудования Ходжикентской ГЭС.',
    ...
    },
    {
        ...
        description: 'Организация и контроль мероприятий по охране труда и промышленной безопасности на объектах гидроэнергетики.',
    ...
    {
        id: 4,
        title: 'Оператор гидротурбин',
        department_id: 13,
        department_name: 'Туямуюнская ГЭС',
        position_id: 104,
        position_name: 'Оператор',
        description: 'Управление работой гидротурбин, контроль параметров выработки электроэнергии.',
        requirements: 'Среднее специальное или высшее техническое образование, опыт работы на ГЭС от 2 лет.',
        employment_type: 'full_time',
        status: 'closed',
        priority: 'low',
        salary_from: 5000000,
...
const MOCK_CANDIDATES: Candidate[] = [
    {
        id: 1,
        vacancy_id: 1,
        vacancy_title: 'Главный инженер гидроагрегатов',
        ...
        stage: 'interview',
        rating: 4.5,
        skills: ['Гидроэнергетика', 'Управление персоналом', 'AutoCAD', 'SCADA'],
    ...
    },
    {
        ...
        stage: 'assessment',
        rating: 4.0,
        skills: ['Гидротурбины', 'Техническое обслуживание', 'Электроника'],
    ...
    },
    {
        id: 5,
        vacancy_id: 4,
        vacancy_title: 'Оператор гидротурбин',
        ...
        stage: 'hired',
        rating: 4.2,
        skills: ['Гидротурбины', 'Мониторинг', 'Техобслуживание'],
...
const MOCK_INTERVIEWS: Interview[] = [
    {
        ...
        duration_minutes: 60,
        location: 'Чарвакская ГЭС, кабинет 204',
        status: 'scheduled',
    ...
    },
    {
        ...
        overall_rating: 4.0,
        recommendation: 'yes',
        feedback: 'Хороший кандидат, имеет релевантный опыт в гидроэнергетике. Рекомендуется к техническому собеседованию.',
    ...
    },
    {
        ...
        duration_minutes: 90,
        location: 'Ходжикентская ГЭС, кабинет директора',
        status: 'completed',
        overall_rating: 4.8,
...
const MOCK_OFFERS: JobOffer[] = [
    {
        ...
        offered_department: 'Ходжикентская ГЭС',
    ...
    },
    {
        ...
        offered_position: 'Оператор гидротурбин',
        offered_department: 'Туямуюнская ГЭС',
...
const MOCK_ONBOARDINGS: Onboarding[] = [
    {
        ...
        tasks: [
            ...
            { id: 4, title: 'Инструктаж по технике безопасности на ГЭС', category: 'compliance', status: 'completed', completed_at: '2026-02-12T14:00:00Z' },
            ...
            { id: 6, title: 'Обучение работе с АСУ ТП гидротурбин', category: 'training', status: 'in_progress', due_date: '2026-03-15' },
            { id: 7, title: 'Стажировка на рабочем месте под наблюдением наставника', category: 'department', status: 'pending', due_date: '2026-04-10' },
            { id: 8, title: 'Сдача экзамена по эксплуатации гидротурбин', category: 'training', status: 'pending', due_date: '2026-05-01' }
        ],
