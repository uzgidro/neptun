...
function mockTimesheets(filter: TimesheetFilter): EmployeeTimesheet[] {
    const employees = [
        { id: 1, name: 'Каримов Бахтиёр Рустамович', code: 'EMP-001', dept: 'Молокозавод «Чирчик»', pos: 'Главный инженер' },
        { id: 2, name: 'Султанова Дилноза Камолидиновна', code: 'EMP-002', dept: 'Центральный аппарат', pos: 'Начальник отдела' },
        { id: 3, name: 'Рахимов Отабек Шухратович', code: 'EMP-003', dept: 'Молокозавод «Фергана»', pos: 'Инженер-технолог' },
        { id: 4, name: 'Абдуллаев Жасур Тохирович', code: 'EMP-004', dept: 'Молокозавод «Джизак»', pos: 'Оператор' },
