...
export class KpiComponent implements OnInit {
    ...
    loadKpis() {
        this.kpis = [
            ...
            { id: 2, name: 'Объём производства продукции', category: 'production', department: 'production', period: 'month', periodDate: new Date(2024, 11, 1), unit: 'mwh', targetValue: 150000, actualValue: 148500, minThreshold: 135000, weight: 15, trend: 'stable', responsiblePerson: 'Иванов И.И.', notes: '' },
            { id: 3, name: 'Коэффициент готовности оборудования', category: 'production', department: 'technical', period: 'month', periodDate: new Date(2024, 11, 1), unit: 'percent', targetValue: 98, actualValue: 96.5, minThreshold: 92, weight: 10, trend: 'down', responsiblePerson: 'Петров П.П.', notes: 'Плановый ремонт линии №2' },
            { id: 4, name: 'Потери при производстве', category: 'production', department: 'technical', period: 'month', periodDate: new Date(2024, 11, 1), unit: 'percent', targetValue: 5, actualValue: 4.8, minThreshold: 8, weight: 10, trend: 'up', responsiblePerson: 'Петров П.П.', notes: '' },
