...
export class ProcurementComponent implements OnInit {
    ...
    loadProcurements() {
        this.procurements = [
            { id: 1, requestNumber: 'ZAK-2024-001', requestDate: new Date(2024, 11, 1), itemName: 'Пастеризатор ПМР-400', category: 'equipment', supplier: 'МолСнаб', quantity: 2, unit: 'pcs', unitPrice: 15000000, totalAmount: 30000000, department: 'technical', priority: 'high', status: 'delivered', plannedDeliveryDate: new Date(2024, 11, 15), actualDeliveryDate: new Date(2024, 11, 14), responsiblePerson: 'Иванов И.И.', notes: 'Для цеха №3' },
            ...
            { id: 9, requestNumber: 'ZAK-2024-009', requestDate: new Date(2024, 10, 20), itemName: 'Сепаратор-сливкоотделитель', category: 'equipment', supplier: 'МолМаш', quantity: 1, unit: 'pcs', unitPrice: 85000000, totalAmount: 85000000, department: 'technical', priority: 'high', status: 'delivered', plannedDeliveryDate: new Date(2024, 11, 1), actualDeliveryDate: new Date(2024, 10, 30), responsiblePerson: 'Иванов И.И.', notes: 'Замена изношенного оборудования' },
