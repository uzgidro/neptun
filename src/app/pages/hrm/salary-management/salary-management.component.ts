...
export class SalaryManagementComponent implements OnInit, OnDestroy {
    ...
    private loadAllData(): void {
        ...
        forkJoin({
            ...
            error: (err) => {
                ...
                this.messageService.add({ severity: 'error', summary: this.translate.instant('COMMON.ERROR'), detail: this.translate.instant('HRM.SALARY.LOAD_ERROR') });
                this.loading = false;
            }
        });
    }
            ...
            .subscribe({
                next: (result) => {
                    ...
                    this.messageService.add({
                        ...
                        detail: this.translate.instant('HRM.SALARY.BATCH_CALCULATION_SUCCESS', { successful: result.successful, total: result.total })
                    });
                },
                error: (err) => {
                    this.calculating = false;
                    ...
                    this.messageService.add({
                        ...
                        detail: this.translate.instant('HRM.SALARY.CALCULATION_ERROR')
                    });
                }
            });
    }
    ...
    submitForApproval(salary: Salary): void {
        ...
        if (index !== -1) {
            ...
            this.messageService.add({
                severity: 'info',
                summary: this.translate.instant('COMMON.SUCCESS'),
                detail: this.translate.instant('HRM.SALARY.SUBMITTED_FOR_APPROVAL', { name: salary.employee_name })
            });
        }
    }
    ...
    submitAllForApproval(): void {
        ...
        this.messageService.add({
            severity: 'success',
            summary: this.translate.instant('COMMON.SUCCESS'),
            detail: this.translate.instant('HRM.SALARY.BATCH_SUBMITTED', { count })
        });
    }
    ...
    confirmApproval(): void {
        ...
        if (index !== -1) {
            ...
            this.messageService.add({
                severity: 'success',
                summary: this.translate.instant('COMMON.SUCCESS'),
                detail: this.translate.instant('HRM.SALARY.APPROVAL_SUCCESS_NAME', { name: this.selectedSalary.employee_name })
            });
        }
    ...
    confirmRejection(): void {
        ...
        if (index !== -1) {
            ...
            this.messageService.add({
                ...
                detail: this.translate.instant('HRM.SALARY.REJECTION_SUCCESS_NAME', { name: this.selectedSalary.employee_name })
            });
        }
    ...
    markAsPaid(salary: Salary): void {
        ...
        if (index !== -1) {
            ...
            this.messageService.add({
                severity: 'success',
                summary: this.translate.instant('COMMON.SUCCESS'),
                detail: this.translate.instant('HRM.SALARY.PAID_SUCCESS', { name: salary.employee_name })
            });
        }
    }
    ...
    markAllAsPaid(): void {
        ...
        this.messageService.add({
            severity: 'success',
            summary: this.translate.instant('COMMON.SUCCESS'),
            detail: this.translate.instant('HRM.SALARY.BATCH_PAID', { count })
        });
    }
    ...
    generatePayslip(salary: Salary): void {
        this.messageService.add({
            severity: 'info',
            summary: this.translate.instant('HRM.SALARY.GENERATING'),
            detail: this.translate.instant('HRM.SALARY.PAYSLIP_GENERATING', { name: salary.employee_name })
        });
    ...
    generatePayrollReport(): void {
        this.messageService.add({
            severity: 'info',
            summary: this.translate.instant('HRM.SALARY.GENERATING'),
            detail: this.translate.instant('HRM.SALARY.PAYROLL_REPORT_GENERATING')
        });
    ...
    generateTaxReport(): void {
        this.messageService.add({
            severity: 'info',
            summary: this.translate.instant('HRM.SALARY.GENERATING'),
            detail: this.translate.instant('HRM.SALARY.TAX_REPORT_GENERATING')
        });
    }
    ...
    generateSocialFundReport(): void {
        this.messageService.add({
            severity: 'info',
            summary: this.translate.instant('HRM.SALARY.GENERATING'),
            detail: this.translate.instant('HRM.SALARY.SOCIAL_FUND_REPORT_GENERATING')
        });
    }
    ...
    confirmDelete(): void {
        ...
        this.messageService.add({
            severity: 'success',
            summary: this.translate.instant('COMMON.SUCCESS'),
            detail: this.translate.instant('HRM.SALARY.DELETE_SUCCESS')
        });
            ...
            .subscribe({
                next: (blob) => {
                    ...
                    this.messageService.add({
                        severity: 'success',
                        summary: this.translate.instant('COMMON.SUCCESS'),
                        detail: this.translate.instant('HRM.SALARY.EXPORT_SUCCESS')
                    });
                },
                error: (err) => {
                    ...
                    this.messageService.add({
                        severity: 'error',
                        summary: this.translate.instant('COMMON.ERROR'),
                        detail: this.translate.instant('HRM.SALARY.EXPORT_ERROR')
                    });
                }
            });
    }
