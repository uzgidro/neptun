...
@Component({
    ...
    templateUrl: './ges-shutdowns-section.component.html',
    styleUrl: './ges-shutdowns-section.component.scss'
})
export class GesShutdownsSectionComponent implements OnInit, OnDestroy {
    @Input() gesId!: number;
    @Input() canEdit = false;
    ...
    currentItem: GesShutdown | null = null;
    ...
    loadData(): void {
        ...
        this.gesService
            .getShutdowns(this.gesId, dateRange)
    ...
    editItem(item: GesShutdown): void {
    ...
    deleteItem(id: number): void {
        if (confirm('Вы уверены, что хотите удалить эту запись?')) {
            this.gesService.deleteShutdown(this.gesId, id).subscribe({
                next: () => {
                    this.messageService.add({
                        severity: 'success',
    ...
    showFiles(item: GesShutdown): void {
