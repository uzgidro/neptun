...
export class GesVisitsSectionComponent implements OnInit, OnDestroy {
    ...
    onSubmit(): void {
        ...
        const payload: VisitCreatePayload & VisitUpdatePayload = {} as VisitCreatePayload & VisitUpdatePayload;
        ...
        const submitWithPayload = (p: typeof payload) => {
            const request$ = this.isEditMode && this.currentItemId
                ? this.gesService.editVisit(this.gesId, this.currentItemId, p)
                : this.gesService.addVisit(this.gesId, p);
